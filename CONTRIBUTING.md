...
task lint:inspect         # the ReSharper inspections Rider shows in the editor, over the whole solution
...
task ci                   # everything CI runs: format check, lints, Release build, tests, coverage gate, pack
```
